        ...
        <div className="">
            <div className="hidden lg:block">
                {isAuthenticated && (
                    <div className="mb-5">
                        <Link to={"/create"}>
                            <Button className="p-4 rounded-md w-full bg-[#574ae6] text-[#f1f2f4] font-semibold transition ease-in-out hover:text-white hover:bg-[#313699]">
            ...
            <div className="lg:hidden">
                ...
                <div className="mt-2 flex items-center justify-between text-sm">
                    ...
                    >
                        ...
                        <span className="hover:underline text-[#162162]">
